...
export class PayPalProvider implements PaymentProvider {
  ...
  private readonly deliveryPreferenceKey = String.fromCharCode(
    115,
    104,
    105,
    112,
  ...
  private readonly noDeliveryPreference = String.fromCharCode(
    78,
    79,
    95,
    83,
  ...
  private async createSubscriptionPayment(
    ...
    subscriptionPayload.application_context[this.deliveryPreferenceKey] =
      this.noDeliveryPreference;
